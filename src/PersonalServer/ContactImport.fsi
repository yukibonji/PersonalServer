...
module ContactImport =
    ...
    val simpleEntityBuilder : sourceMeta : ImportSourceMeta -> tryParse : (string * Set<Tag> * NonEmptySet<Source> -> 'a option) -> displ : int -> columns : string [] -> 
        'a option * Set<Tag>

    val entityBuilders : sourceMeta : ImportSourceMeta -> tryParse : (string * Set<Tag> * NonEmptySet<Source> -> 'a option) ->  coveredHeaderColumns : int [] ->  entityCstr : ('a -> 'b) -> 
